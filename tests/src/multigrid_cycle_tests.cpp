...
void test_v_cycle(Grid &a, Grid &b, Grid &residual, Grid &error,
    ...
    for (auto i = 0; i < num_cycles; i++) {
        v_cycle(a, actual, b, residual, error, num_iterations, 0, 0);
    }
...
void run_cycle_tests() {
    ...
    test_v_cycle(a, b, residual, error, expected_values, 3, num_cycles);
    test_w_cycle(a, b, residual, error, expected_values, 3, 1);
    ...
    test_v_cycle(a, b, residual, error, expected_values, 3, num_cycles);
    test_w_cycle(a, b, residual, error, expected_values, 3, num_cycles);
